...
struct BAKERY* get_number_1_svc(struct BAKERY *argp, struct svc_req *rqstp)
{
	setbuf(stdout, NULL);
...
struct BAKERY* wait_queue_1_svc(struct BAKERY *argp, struct svc_req *rqstp)
{
	setbuf(stdout, NULL);
	static struct BAKERY result;
...
struct BAKERY* bakery_res_1_svc(struct BAKERY *argp, struct svc_req *rqstp)
{
	setbuf(stdout, NULL);
	static struct BAKERY result;
